...
@JsonKey(name: 'user_id') String get userId; String? get nickname;@JsonKey(name: 'photo_url') String? get photoUrl; String? get gender;@JsonKey(name: 'height_cm') num? get heightCm;@JsonKey(name: 'weight_kg') num? get weightKg;@JsonKey(name: 'birth_year') int? get birthYear;
...
@override
String toString() {
  return 'ProfilesDto(userId: $userId, nickname: $nickname, photoUrl: $photoUrl, gender: $gender, heightCm: $heightCm, weightKg: $weightKg, birthYear: $birthYear)';
}
...
@useResult
$Res call({
@JsonKey(name: 'user_id') String userId, String? nickname,@JsonKey(name: 'photo_url') String? photoUrl, String? gender,@JsonKey(name: 'height_cm') num? heightCm,@JsonKey(name: 'weight_kg') num? weightKg,@JsonKey(name: 'birth_year') int? birthYear
});
...
/// Create a copy of ProfilesDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? nickname = freezed,Object? photoUrl = freezed,Object? gender = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? birthYear = freezed,}) {
...
class _ProfilesDto implements ProfilesDto {
  const _ProfilesDto({@JsonKey(name: 'user_id') required this.userId, this.nickname, @JsonKey(name: 'photo_url') this.photoUrl, this.gender, @JsonKey(name: 'height_cm') this.heightCm, @JsonKey(name: 'weight_kg') this.weightKg, @JsonKey(name: 'birth_year') this.birthYear});
...
/// Create a copy of ProfilesDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? nickname = freezed,Object? photoUrl = freezed,Object? gender = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? birthYear = freezed,}) {
