...
mixin _$ProfilesEntity {
 ...
 String get userId; String? get nickname; String? get photoUrl; GenderType? get genderType; double? get heightCm; double? get weightKg; int? get birthYear;
...
@override
int get hashCode => Object.hash(runtimeType,userId,nickname,photoUrl,genderType,heightCm,weightKg,birthYear);

@override
String toString() {
  return 'ProfilesEntity(userId: $userId, nickname: $nickname, photoUrl: $photoUrl, genderType: $genderType, heightCm: $heightCm, weightKg: $weightKg, birthYear: $birthYear)';
}
...
@useResult
$Res call({
 String userId, String? nickname, String? photoUrl, GenderType? genderType, double? heightCm, double? weightKg, int? birthYear
});
...
/// Create a copy of ProfilesEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? nickname = freezed,Object? photoUrl = freezed,Object? genderType = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? birthYear = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String userId,  String? nickname,  String? photoUrl,  GenderType? genderType,  double? heightCm,  double? weightKg,  int? birthYear)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfilesEntity() when $default != null:
return $default(_that.userId,_that.nickname,_that.photoUrl,_that.genderType,_that.heightCm,_that.weightKg,_that.birthYear);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String userId,  String? nickname,  String? photoUrl,  GenderType? genderType,  double? heightCm,  double? weightKg,  int? birthYear)  $default,) {final _that = this;
switch (_that) {
case _ProfilesEntity():
return $default(_that.userId,_that.nickname,_that.photoUrl,_that.genderType,_that.heightCm,_that.weightKg,_that.birthYear);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String userId,  String? nickname,  String? photoUrl,  GenderType? genderType,  double? heightCm,  double? weightKg,  int? birthYear)?  $default,) {final _that = this;
switch (_that) {
case _ProfilesEntity() when $default != null:
return $default(_that.userId,_that.nickname,_that.photoUrl,_that.genderType,_that.heightCm,_that.weightKg,_that.birthYear);case _:
  return null;
...
class _ProfilesEntity extends ProfilesEntity {
  const _ProfilesEntity({required this.userId, this.nickname, this.photoUrl, this.genderType, this.heightCm, this.weightKg, this.birthYear}): super._();
...
/// Create a copy of ProfilesEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? nickname = freezed,Object? photoUrl = freezed,Object? genderType = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? birthYear = freezed,}) {
